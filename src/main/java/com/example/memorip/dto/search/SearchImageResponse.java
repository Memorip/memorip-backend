...
public class SearchImageResponse {
    ...
    private List<SearchImageItem> items; // XML 포멧에서는 item 태그로, JSON 포멧에서는 items 속성으로 표현된다. 개별 검색 결과이며 title, link, thumbnail, address, sizeheight, sizewidth를 포함한다.
    ...
    public static class SearchImageItem{
        ...
        private String sizewidth;  // 검색 결과 이미지의 너비. 단위는 pixel이다.
    }
}